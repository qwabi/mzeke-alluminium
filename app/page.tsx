...
const productCategories = [
  ...
  },
  {
    ...
    icon: DoorOpen,
    image: "https://images.unsplash.com/photo-1509644851169-2acc08aa25b5?q=80&w=2940&auto=format&fit=crop",
  },
  {
  ...
  {
    title: "Windows",
    products: ["Casement 30.5 Side Hung Windows", "Casement 30.5 Top Hung Windows"],
    icon: LayoutGrid,
    image: "https://images.unsplash.com/photo-1604014237800-1c9102c219da?q=80&w=2940&auto=format&fit=crop",
  },
  {
    title: "Shower Solutions",
    products: ["Pivot Shower Door", "Tri-Glide Shower Door", "Custom Shower Enclosures"],
    icon: Shower,
    image:
  ...
  },
  {
    ...
    products: ["Frameless Balustrades", "Wine Cellar Solutions", "Custom Glass Installations"],
    icon: Wine,
    image:
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-20 items-center">
          <Link href="/" className="flex items-center space-x-3">
            ...
            />
            <span className="font-bold text-xl text-[#004aad]">Mzeke Aluminium</span>
          </Link>
          <nav className="ml-auto flex gap-4 sm:gap-6">
            <a href="#products" className="text-sm font-medium hover:text-[#004aad] transition-colors">
              Products
            </a>
            <a href="#features" className="text-sm font-medium hover:text-[#004aad] transition-colors">
              Features
            </a>
            <a href="#testimonials" className="text-sm font-medium hover:text-[#004aad] transition-colors">
              Testimonials
            </a>
            <a href="#contact" className="text-sm font-medium hover:text-[#004aad] transition-colors">
              Contact
            </a>
          </nav>
        </div>
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4 text-white">
                ...
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-zinc-100 md:text-xl">
                    Specializing in custom doors, windows, and frameless glass installations. Cape Town's trusted
                    aluminium experts.
                  </p>
                </div>
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button size="lg" className="bg-white text-[#004aad] hover:bg-zinc-100" onClick={scrollToContact}>
                    Get a Free Quote
                  </Button>
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Experience", description: "Years of industry expertise", icon: Clock },
                { title: "Quality", description: "Premium materials and craftsmanship", icon: CheckCircle },
                { title: "Affordability", description: "Competitive pricing for all budgets", icon: Banknote },
                { title: "Support", description: "Dedicated customer service", icon: Headphones },
              ].map((feature, index) => (
                <Card
                  key={index}
        ...
        <section id="contact" className="w-full py-12 md:py-24 lg:py-32 bg-[#004aad] text-white">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="max-w-[600px] text-zinc-100 md:text-xl mb-8">
                Ready to enhance your home? Contact us for a free quote or any inquiries.
              </p>
      ...
      <footer className="w-full border-t bg-white">
        <div className="container flex flex-col gap-4 py-10 px-4 md:px-6">
          ...
          <div className="flex flex-col gap-2 sm:flex-row justify-between items-center border-t pt-6">
            <p className="text-xs text-zinc-500">© 2024 Mzeke Aluminium. All rights reserved.</p>
