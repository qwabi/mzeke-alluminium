    ...
    <>
      ...
      >
        ...
        >
          <div className='container flex h-20 items-center justify-between'>
            <Link
              ...
              aria-label='Mzeke Aluminium Home'
            >
              <Image
              ...
              />
              <span
                className='font-bold text-xl text-[#004aad]'
                itemProp='name'
              >
                Mzeke Aluminium
              </span>
        ...
        <main className='flex-1' role='main'>
          <section
            className='relative w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-[#004aad] overflow-hidden'
        ...
        <footer className='w-full border-t bg-white' role='contentinfo'>
          <div className='container flex flex-col gap-4 py-10 px-4 md:px-6'>
            ...
            <div className='w-full border-t'>
              <div className='container flex justify-center py-4 text-xs text-zinc-500'>
                Built for maximum impact by{' '}
                <a
                  href='https://ayabonga.com'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='ml-1 text-[#004aad] hover:underline'
                >
                  Ayabonga Qwabi
                </a>
              </div>
